        ...
        unsafe {
            if input.is_empty() {
                ...
                *self.index.as_mut().unwrap() += input.len;
                ...
                // Cur is Null but Self exists, append to back
                let in_front = input.front.take().unwrap();
                let in_back = input.back.take().unwrap();
                ...
                // Self is empty, become the input
    ...
    unsafe {
        if input.is_empty() {
            ...
            if let Some(next) = (*cur.as_ptr()).back {
                ...
                // No next, append to back
                (*cur.as_ptr()).front = Some(in_front);
                (*in_front.as_ptr()).back = Some(cur);
            ...
            *self.index.as_mut().unwrap() += input.len;
            ...
            // Cur is Null but Self exists, append to front
            let in_front = input.front.take().unwrap();
            let in_back = input.back.take().unwrap();
